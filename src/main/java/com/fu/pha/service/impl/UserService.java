...
import com.fu.pha.exception.ResponseException;
...
@Service
public class UserService implements com.fu.pha.service.UserService {
    ...
    public ServiceResponse<JwtResponse> login(LoginDtoRequest loginDtoRequest) {
        try {
            ...
            throw new ResponseException(HttpStatus.UNAUTHORIZED, ResponseMessage.INVALID_USERNAME);
        } catch (LockedException e) {
            throw new ResponseException(HttpStatus.LOCKED, ResponseMessage.ACCOUNT_LOCKED);
        } catch (DisabledException e) {
            throw new ResponseException(HttpStatus.FORBIDDEN, ResponseMessage.ACCOUNT_DISABLED);
        } catch (Exception e) {
            throw new ResponseException(HttpStatus.INTERNAL_SERVER_ERROR, ResponseMessage.LOGIN_ERROR);
        }
    }
